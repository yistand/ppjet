...
int main() {
	...
	fout << "char const PTBINS[NUMBEROFPT][10]={\"2_3\",\"3_4\",\"4_5\",\"5_7\",\"7_9\",\"9_11\",\"11_15\",\"15_20\",\"20_25\",\"25_35\",\"35_-1\"};" <<endl;
	fout << "float const XSEC[NUMBEROFPT] = {";
	for(int i = 0; i<NpT-1; i++) {
		fout << avexsec[i] << ", ";
	}
	fout << avexsec[NpT-1] << "};" << endl;
	fout << "float const NUMBEROFEVENT[NUMBEROFPT] = {";
	for(int i = 0; i<NpT-1; i++) {
		fout << totalevent[i] << ", ";	
	}
