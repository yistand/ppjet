...
//
//	2018.03.23	Li YI
//	modified from plotpythia8_bypT.C
//	Read Pythia6 Perugia2012 default tune generated by Kevin 
//
//
//===================================================================================================================
//
...
//void plotpythia6KevinDefault_bypT(const char *tag = "", const char *var = "maxpt", bool flagMC05 = false) {	
void plotpythia6KevinDefault_bypT(const char *tag = "default", const char *var = "j1pt", bool flagMC05 = false) {	
//
...
//	tag: "default" 
	...
	//const char *filenameformat = "%sFullJet_TransCharged_pythia6_pp200Hard%s_Perugia2012Def_PionDecayOff_pt%d-%d.root";
	const char *filenameformat = "%sFullJet_TransCharged_pythia6_pp200Hard_Perugia2012Def_PionDecayOff_pt%d-%d.root";

	const char* xsecfile = "Xsec4pythia6%s_pp200hard_PionDecayOff.csv";
	...
	while(getline(xfin, line)) {		// loop each pT bin
		...
		TFile *f = new TFile(Form(filenameformat, pretag.Data(), int(pt1),int(pt2)));
		//if(!f->IsOpen()) {cout<<"Cannot open "<<Form(filenameformat, pretag.Data(), tag, int(pt1),int(pt2))<<endl; continue;}
		if(!f->IsOpen()) {cout<<"Cannot open "<<Form(filenameformat, pretag.Data(), int(pt1),int(pt2))<<endl; continue;}
	...
	//TString outname = pretag+Form("Profile_finebin_pythia6%s_pp200hard_PionDecayOff_seed171114_170422.root",tag);;
	TString outname = pretag+Form("Profile_12JetBinv2_FullJet_TransCharged_pythia6%s_pp200hard_PionDecayOff_180324.root",tag);
